...
/*   Updated: 2024/07/28 21:33:32 by jose-cda         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	break_number(char *number)
{
	...
	{
		first = number + (str_len(number) - 18);
		substring(number, second, str_len(number) - 36,
			(str_len(number) - 18 - 1));
...
void	process_large_number(int inc,char *number)
{
	...
	num = ft_atoll(number);
	scale = count_triples(number);
	printed = 0;
	casas = count_triples(number);
	a = 0;
	temp = count_triples(number);
	while (scale > 0)
	{
