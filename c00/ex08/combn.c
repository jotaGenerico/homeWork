...
void	ft_print_combn_recursive(int current, int max, int n);
...
void	ft_print_combn_recursive_helper(int current, int max, int n)
{
...
void	ft_print_combn_recursive(int current, int max, int n)
{
	ft_print_combn_recursive_helper(current, max, n);
	current = ft_next_numbers(current, n);
	ft_print_combn_recursive(current, max, n);
}
...
void	ft_print_combn(int n)
{
	...
	ft_print_combn_recursive(current, number_max[n - 1], n);
	write(1, "\n", 1);
}
